class ArcticScene {
    ...
    buildUI() {
        ...
        <div id="ui-layer" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; pointer-events: none; display: flex; flex-direction: column; justify-content: space-between; z-index: 10;">
            <div id="hud-top" style="padding: 25px; text-align: center;"><p id="score-display" style="font-size: 2.8rem; font-weight: 900; color: #0ea5e9; text-shadow: 2px 3px 0px #000; margin: 0;">PONTUAÇÃO: 0</p></div>
